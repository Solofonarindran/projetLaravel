$("document").ready(function(){
        ...
        /*modifier*/	$('#insertcontenir').on('click',()=>{
						
						var idpneu= $('input:text[name=idpneu]').val()
						var prixachat= $('input[name=prixachat]').val()
						
						var number=$('input[name=number]').val()
						var idFourni=$('input:text[name=showid]').val()
							...
							success:function(responses){
								...
								$.each(responses,function(index,value){
									...
									if(i==0){
											...
											$("input:text[name=showMouvRef]").val(value[0])
											$("input:text[name=showMouvMark]").val(value[1])
											$("input:text[name=showStockRec]").val(value[2])
											$("input:text[name=showStockUpdate]").val(value[3])
										
									}else{
										
										 data+='<tr><td>'+value[0]+'</td><td>'+value[1]+'</td><td>'+value[2]+'</td><td>'
													 +value[3]+'</td><td>'+value[4]+'</td><td>'+value[5]+'</td></tr>'
