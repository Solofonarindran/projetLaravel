...
<main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="container">
                            <div data-size="A4">
                               ...
                               <?php
                                    $tranche=($response->prix)/($response->contrat->duration)
                                            ...
                                            <table class="table mt-5">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="text-center border-top-0 table-scale-border-bottom fw-700">Durée d'echeance</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-left">{{$response->contrat->libele}}</td>
                                                        
                                                        <td class="text-center">{{$response->contrat->duration}} mois</td>
                                        ...
                                        <table class="table table-clean">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{$response->prix}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-left">
                                                ...
                                                <tr class="table-scale-border-top border-left-0 border-right-0 border-bottom-0">
                                                    ...
                                                    <td class="text-right keep-print-font">
                                                        <h4 class="m-0 fw-700 h2 keep-print-font">{{$response->prix}}</h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="text-left">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right keep-print-font">
                                                        <h4 class="m-0 fw-700 h2 keep-print-font text-danger">{{$response->prix}}</h4>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h4 class="py-5 text-primary">
                                            Contrat : {{$response->contrat->libele}} <br>
                                            Duré d'echeance: {{$response->contrat->duration}} mois

                                        </h4>
                                        <h4 class="py-2 text-primary">
                                             Je déclare sur l'honneur porté le nom {{$client->name}} au-dessus que j'accepte tous les conditions du payement.
                                            <br>
