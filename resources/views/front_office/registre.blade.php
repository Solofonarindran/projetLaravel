                ...
                <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                    <div class="d-flex justify-content-center py-4">
                        <a href="pages-login.html" class="logo d-flex align-items-center w-auto">
                            <span class="d-block" style="font-size: 50px; letter-spacing:2px">
                                E-GELODGE
                            </span>
                        </a>
                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{route('custreg')}}" method="POST" >
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 p-2 fs-6" type="submit" id="login">Créer</button>
                                </div>
                                <div class="col-12">
                                    <p class="small mb-0">J'ai déjà un compte. <a href="{{route('login')}}">Se connecter</a></p>
                                </div>
