...
<div class="row">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" style="opacity:0" id="animate2"><a href="">Home</a></li>
                    <li class="breadcrumb-item active" style="opacity:0" id="animate3">Lodge vendu payé</li>
                </ol>
            </nav>
                            ...
                            <div class="actualite-footer mt-3">
                                ...
                                <div class="share">
                                    <button class="d-flex btn btn" data-bs-toggle="modal" data-bs-target="#modalShare">
                                        <a href="{{route('contratfact',['id'=>$lodge->id])}}"><span>Contrat</span></a>
        ...
        <div class="sidebar-right">
            ...
            <div class="card">
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="news" id="new-offre">Titre</a></h4>
